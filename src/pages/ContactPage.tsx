      ...
      <div className="px-4 pb-8 space-y-3">
        {contacts.map(({ icon: Icon, label, desc, href, cta }) => (
          <a
            ...
            className="flex items-center gap-3 rounded-2xl border border-border bg-card/55 backdrop-blur-md p-4 transition-colors hover:border-primary/30 hover:bg-primary/5"
          >
